...
public class PoiAroundSearchActivity extends AppCompatActivity implements PoiSearch.OnPoiSearchListener, AMap.OnMapClickListener, AMap.OnMarkerClickListener {
    ...
    public void onViewClicked() {
        keyWord = btnSearch.getText().toString().trim();
        if (null != keyWord) {
            doSearchQuery();
        }
    }
