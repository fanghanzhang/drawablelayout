	...
	public void nextButton() {
		if (query != null && poiSearch != null && poiResult != null) {
			if (poiResult.getPageCount() - 1 > currentPage) {
				...
				Toast.makeText(PoiKeywordSearchActivity.this, "无结果",Toast.LENGTH_SHORT).show();
			}
		}
	}
...
//		searchButton();
	...
	public void onPoiSearched(PoiResult result, int rCode) {
		...
		markerOption.icon(BitmapDescriptorFactory.fromResource(R.drawable.sousuo));
		...
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {
			if (result != null && result.getQuery() != null) {// 搜索poi的结果
				...
				Toast.makeText(this,"wu无结果",Toast.LENGTH_SHORT).show();
			}
		} else {
			Toast.makeText(this,"wujieg无结果",Toast.LENGTH_SHORT).show();
		}
	...
	public void onGetInputtips(List<Tip> tipList, int rCode) {
		if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
			...
			TextView textView =findViewById(R.id.online_user_list_item_textview);
